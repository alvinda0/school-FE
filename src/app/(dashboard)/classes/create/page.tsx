...
const CreateClassPage = () => {
  ...
  const handleChange = (field: keyof CreateClassPayload, value: any) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Tambah Kelas Baru</h1>
          <p className="text-gray-500 mt-1">Isi form untuk menambahkan kelas baru</p>
        </div>
      </div>
